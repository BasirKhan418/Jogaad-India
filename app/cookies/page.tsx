    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100 py-20 mt-20">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-[#F9A825]/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
            <Cookie className="w-5 h-5 text-[#F9A825]" />
            <span className="text-[#0A3D62] font-medium">Data & Cookie Management</span>
          </div>
